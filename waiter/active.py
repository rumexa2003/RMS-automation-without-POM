...
with sync_playwright() as p:
    ...
    page.get_by_text("Active Order").click()
    page.wait_for_timeout(1000)

    page.get_by_role("button", name="Pending").click()
    page.wait_for_timeout(1000)

    page.get_by_role("button", name="Cooking").click()
    page.wait_for_timeout(1000)


    page.get_by_role("button", name="Ready to Serve").click()
    page.wait_for_timeout(1000)

    page.get_by_role("button", name="Served").click()
    page.wait_for_timeout(1000)

    
    page.get_by_role("button", name="Waste").click()
